...
const NumberInput: React.FunctionComponent<NumberInputProps> = ({ name, value, onChange, onChangeForHook, error }) => {
    ...
    return <div className={classes.numberField}>
        ...
        <div className="controls">
            <span onClick={up}><FontAwesomeIcon icon={faChevronUp} /></span>
            <span onClick={down}><FontAwesomeIcon icon={faChevronDown} /></span>
        </div>
    </div>;
};
