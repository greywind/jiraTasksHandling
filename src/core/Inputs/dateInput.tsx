...
const DateInput: React.FunctionComponent<DateInputProps> = ({ name, value, onChange, onChangeForHook, error, format, readonly, min }) => {
    const classes = useStyles();
    const onChangeProxy = useCallback((param: Date) => {
        onChange?.(name, param);
    ...
    return <div className={classes.wrapper}>
        <DatePicker
            ...
            className={classnames({ "form-control": true, "w-100": true, "is-invalid": !!error })}
